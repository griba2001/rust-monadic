...
[*flat_mapping*](https://doc.rust-lang.org/std/iter/trait.Iterator.html#method.flat_map) with lambdas as closures forcing with *move* the capture of closure vars and arg.
